...
const OrderDetailsTable = () => {
  ...
  const rows = [
    createData("Frozen ", 159, 6.0, 24, 4.0, imgSrc),
    createData("Ice cream sandwich", 237, 9.0, 37, 4.3, imgSrc),
    createData("Eclair", 262, 16.0, 24, 6.0, imgSrc),
    createData("Cupcake", 305, 3.7, 67, 4.3, imgSrc),
    createData("Gingerbread", 356, 16.0, 49, 3.9, imgSrc),
  ];
